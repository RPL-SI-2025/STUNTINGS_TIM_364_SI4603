...
<head>
    ...
    <title>Tambah Pencapaian Tahapan Perkembangan</title>
            ...
            <div class="card-body">
                <form action="{{ route('orangtua.tahapan_perkembangan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="tahapan_perkembangan_id" id="tahapan_perkembangan_id" required>
                            ...
                            @foreach($tahapanPerkembangan as $tahapan)
                                <option value="{{ $tahapan->id }}">{{ $tahapan->nama_tahapan }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_pencapaian" id="tanggal_pencapaian" required>
                    </div>
